...
from imageboards.views import BoardViewSet, ThreadViewSet, ThreadsFeedViewSet, PostViewSet
...
# /threadfeed/
# /threadfeed/{pk}/
default_router.register('threadsfeed', ThreadsFeedViewSet, basename='threadfeed')
